...
This project should be completed within 2 - 5 hours. Please do not spend more time than this.

1. Complete the GraphQL Query to search for 151 Pokemon.
2. Display the results from the query.
3. Allow users to save a Pokemon to their Pokedex which is a Redux State.
...
3. Write a redux action that will remove all Pokemon currently saved in their Pokedex.
4. Let the user search the list of Pokemon though input.
...
- Please create a public repo on your GitHub for your code and sumbit a link to the repo
